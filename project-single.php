        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section class="no-top">
                <div class="container">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <img src="images/projects/1.jpg" class="img-fluid rounded-20px wow scaleOut"
                                data-wow-delay=".0s" alt="">
                        </div>
                        <div class="col-lg-6">
                            <img src="images/projects/2.jpg" class="img-fluid rounded-20px wow scaleOut"
                        ...
                        <div class="col-lg-9">
                            <p>In nisi proident aliqua et nulla ut cillum cupidatat laborum dolore labore commodo
                                voluptate tempor non consequat laboris excepteur ad veniam sunt aliquip exercitation
                                velit laborum aliquip commodo excepteur sed nisi anim anim velit qui dolore anim laboris
                                est dolor incididunt mollit ut ullamco sint adipisicing reprehenderit ad reprehenderit
                                ut magna adipisicing labore laboris laboris fugiat ut eiusmod aliqua dolore minim amet
                                occaecat occaecat amet id excepteur sed dolor consectetur laborum irure in sint et sit
                                nostrud et cupidatat proident ad duis commodo velit velit eu eiusmod laboris anim minim.
                            </p>
                        </div>
