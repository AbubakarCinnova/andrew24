...
<title>Andrew Casey Technologies | Maintenance</title>
            ...
            <section>
                <div class="container">
                    <div class="row g-5">
                        ...
                        <div class="col-lg-9">
                            <h2>Did you <span class="id-color-2">experience</span> one of issues below:</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <ol class="ol-style-1">
                                        ...
                                        <li>Clogged Drainage</li>
                                        <li>Electrical Issues</li>
                                        <li>Uneven Heating or Cooling</li>
                                    </ol>
                                </div>
                            </div>
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6 wow fadeInRight">
                                    <img src="images/misc/7.webp" class="img-fluid rounded-20" alt="">
                                </div>
