                ...
                <div class="container relative z-index-1000">
                    <div class="row g-4 gx-5">
                        ...
                        <div class="col-lg-6">
                            ...
                            <p>Experience unparalleled comfort and efficiency with our state-of-the-art Air Conditioning
                                Unit. Engineered with the latest technology, our air conditioner ensures optimal cooling
                                while maintaining energy efficiency. Perfect for both residential and commercial spaces,
                                it offers a seamless blend of performance, durability, and sleek design.</p>
                            ...
                            <ol class="ol-style-1 fs-16">
                                <li><span class="fw-bold text-dark me-2">Efficient Cooling:</span>Rapidly cools your
                                    space, providing immediate relief from heat.</li>
                                <li><span class="fw-bold text-dark me-2">Energy Saving:</span>Designed to consume
                                    minimal power, reducing your electricity bills without compromising performance.
                                </li>
                                <li><span class="fw-bold text-dark me-2">Quiet Operation:</span>Operates at a low noise
                                    level, ensuring a peaceful environment for work or rest.</li>
                            </ol>
